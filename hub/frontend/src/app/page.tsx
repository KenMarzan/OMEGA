...
import Slidescreen from "@/ui/modals/Slidescreen";
    ...
    <Navbar/>
        <div className="content mt-8 p-4">
          <div className="slidescreen flex flex-col gap-8">
            <Slidescreen title="Harvest From Farmers" content="Explore the variety of products harvested by farmers."/>
            <Slidescreen title="Market Prices and SRP" content="Stay updated with the latest market prices and suggested retail prices."/>
          </div>
