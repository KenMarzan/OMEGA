...
export default function MarketAnalysis(): React.JSX.Element {
    ...
    switch (currentContent) {
        case 0:
            contentToDisplay = (
                <div id="stocks">
                    <img src="https://b83eeb945e2915539af8.ucr.io/-/quality/best/https://d1qwl4ymp6qhug.cloudfront.net/Images%20for%20blog/Market%20Analysis%20Examples/market-analysis-examples-1.jpg" alt="" />
                </div>
            );
            break;
        case 1:
