...
export default function MainPage() {
  ...
  return (
    <div className="relative min-h-screen">
      ...
      {showOverlay && (
        <div
          className="absolute inset-0 bg-gray-900 text-white flex items-center justify-center z-50"
      ...
      {/* Main Website */}
      <nav className={`flex justify-between items-center p-4 bg-gray-800 text-white ${showOverlay ? "pointer-events-none" : ""}`}>
        <div className="logo">
