...
import { default as SlideScreenContent } from "@/ui/modals/Slidescreen";
    ...
    <Navbar/>
        <div className="content mt-8 p-4">
          <div className="slidescreen flex flex-col gap-8">
            <SlideScreenContent title="Harvest From Farmers" content="Explore the variety of products harvested by farmers."/>
            <SlideScreenContent title="Market Prices and SRP" content="Stay updated with the latest market prices and suggested retail prices."/>
          </div>
