...
const SlideScreen: React.FC = () => {
    ...
    useEffect(() => {
        if (imagePaths.length === 0) {
            ...
            return; // Stops the effect if no images
        }
    ...
    }, [imagePaths]); // Dependency array: re-runs if imagePaths changes (though here it's constant)
    ...
    if (imagePaths.length === 0) {
        return (
            <div className="slide-screen">
                ...
                <p style={{ color: 'white' }}>No slideshow images available.</p>
            </div>
        );
    }
    ...
    return (
        <div className="slide-screen">
            ...
            <div
                className="slides"
                style={{
                    transform: `translateX(-${currentIndex * 100}vw)`, // Correctly shifting by viewport width
                }}
            >
